...
<body>
    ...
    <nav>
        <div class="add">
            <form style="padding-top: 10px;" action="{{ route('category.create') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="text" name="category_name" id="product_name" placeholder="Category Name">
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td class="btns">
                            <form action="{{ route('admin.show_category', $category->id) }}">
                                <button class="btn1" style="color: #FFFFFF" type="submit">show</button>
                            </form>
                            <form method="POST" action="{{ route('admin.destroy_category', $category->id) }}
                                ">
                                @method('DELETE')
                                @csrf
